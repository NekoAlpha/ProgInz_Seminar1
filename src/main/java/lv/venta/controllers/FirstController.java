...
public class FirstController {
	...
	public String productByParamFunc(@RequestParam("title") String title, Model model) {
		if(title!=null) {
			Product temp;
			try {
				ArrayList<Product> temp1 = crudService.retrieveAllProductByTitle(title);
				model.addAttribute("myAllProducts", temp1);
	...
	//TODO Uzlikt visām savām validācijām ziņojumus
